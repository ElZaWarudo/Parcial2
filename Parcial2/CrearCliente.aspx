<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CrearCliente.aspx.cs" Inherits="Formativa_runt.CrearCliente" %>
    ...
    <div class="container mx-auto center ">
        <form id="form1" runat="server">
            <div class="card bg-light p-4">
                <h2 class="mb-2">Formulario de creación de clientes</h2>
                <asp:GridView CssClass="table table-hover" ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="SqlDataSource1">
                    <Columns>
                        ...
                        <asp:BoundField DataField="FormadePago" HeaderText="FormadePago" SortExpression="FormadePago" />
                    </Columns>
                </asp:GridView>
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [Cliente]" DeleteCommand="DELETE FROM [Cliente] WHERE [Id] = @Id" InsertCommand="INSERT INTO [Cliente] ([Cedula], [Nombre], [Apellido], [Direccion], [Telefono], [Celular], [Correo], [Edad], [Sexo], [Fecha], [FormadePago]) VALUES (@Cedula, @Nombre, @Apellido, @Direccion, @Telefono, @Celular, @Correo, @Edad, @Sexo, @Fecha, @FormadePago)" UpdateCommand="UPDATE [Cliente] SET [Cedula] = @Cedula, [Nombre] = @Nombre, [Apellido] = @Apellido, [Direccion] = @Direccion, [Telefono] = @Telefono, [Celular] = @Celular, [Correo] = @Correo, [Edad] = @Edad, [Sexo] = @Sexo, [Fecha] = @Fecha, [FormadePago] = @FormadePago WHERE [Id] = @Id">
                    <DeleteParameters>
                    ...
                    <InsertParameters>
                        ...
                        <asp:Parameter Name="FormadePago" Type="String" />
                    </InsertParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="Cedula" Type="String" />
                        <asp:Parameter Name="Nombre" Type="String" />
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="pago" runat="server">
                ...
                <div class="d-flex justify-content-center mt-4">
                    <asp:Button ID="Button" runat="server" Text="Crear" OnCommand="Button1_Click" class="btn btn-primary me-3" />
